<?php
	...
	class Masukan extends CI_Controller {
		...
		public function index(){
			$this->form_validation->set_rules('peg_nama', 'Nama Petugas', 'trim');
			...
			$this->form_validation->set_rules('nama_kategori', 'Jenis Layanan', 'trim');
			$this->form_validation->set_rules('tempat_kegiatan', 'Tempat Kegiatan', 'trim');
			$this->form_validation->set_rules('foto', 'Upload Foto', 'trim');
